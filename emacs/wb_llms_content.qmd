...
Some packages provide mechanisms for safe storing or logging. Others don't. In that case, there are multiple options. My favourites are based on [auth-source](https://www.gnu.org/software/emacs/manual/html_mono/auth.html) and [GPG](https://www.gnupg.org/).
...
[GitHub copilot](https://github.com/features/copilot) code completion (built on top of the GitHub [copilot-language-server](https://github.com/github/copilot-language-server-release)).
...
[aider](https://github.com/Aider-AI/aider) in Emacs (forget about Cursor).
