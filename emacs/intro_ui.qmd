...
A frame can be split into several *windows*.
...
Between the buffer and the echo area is *the mode line*, a area that gives information on running modes, file name and path, place of the cursor in the buffer, whether the document has been modified, etc.
