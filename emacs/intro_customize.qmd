...
For example, to enter the Python group, you would run `M-x customize-group python`.

To customize one of the variables (e.g. `python-indent-offset`), you can select it from the group page, or you can access it directly with `M-x customize-variable python-indent-offset`.

To customize a face (e.g. `font-lock-keyword-face`), you can run `M-x customize-face font-lock-keyword-face`. If you place the cursor on an element of that face, its name will appear as the default.

:::

It will add customization at the top of your init file. If this file doesn't exist, it will automatically create it.
