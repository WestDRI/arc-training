...
As an example, I am sharing here my own configurations (menus most kbds which rely on an exotic self-made system), including those for [eglot](https://github.com/joaotavora/eglot)—Emacs client for Language Server Protocol servers, [Abbrevs](https://www.gnu.org/software/emacs/manual/html_node/emacs/Abbrevs.html)—Emacs abbreviation system, [yasnippet](https://github.com/joaotavora/yasnippet)—a template system for Emacs, and [copilot](https://github.com/copilot-emacs/copilot.el), an Emacs plug-in to [GitHub Copilot](https://github.com/features/copilot).
