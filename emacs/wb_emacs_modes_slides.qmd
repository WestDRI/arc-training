...
[use-package](https://github.com/jwiegley/use-package) has the `:init` and `:config` keyword symbols that makes the following expressions evaluated before and after the loading of a package respectively
