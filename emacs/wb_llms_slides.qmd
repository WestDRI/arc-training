...
## My setup (see [warning](#warning-about-my-setup)) {.center}
...
## Integration with [gptel](https://github.com/karthink/gptel) {.center}
...
## Integration with [copilot-chat.el](https://github.com/chep/copilot-chat.el) {.center}
