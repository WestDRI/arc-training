...
Makes compiler optimization much easier → [faster Elisp code = faster Emacs]{.emph}

:::

## Emacs with [JIT native compilation](https://www.gnu.org/software/emacs/manual/html_node/elisp/Native-Compilation.html) {.center}
...
- [Install Emacs `--with-native-compilation`](https://www.emacswiki.org/emacs/GccEmacs)

## Lazy loading with [use-package](https://github.com/jwiegley/use-package) {.center}

*Built-in since version 29*

# Better syntax highlighting

## [Tree-sitter](https://tree-sitter.github.io/tree-sitter/) for [Emacs](https://www.emacswiki.org/emacs/Tree-sitter) {.center}

*Built-in since version 29*

Files in programming languages are parsed accurately instead of using regular expressions
...
*With optional Counsel and Swiper*

![From [abo-abo/swiper](https://github.com/abo-abo/swiper)](img/ivy.png)

## New framework {.center}

New set of packages which use default Emacs functions (less code)
...
- Easy jump back & forth between minibuffer and buffer
...
[Eglot](https://github.com/joaotavora/eglot) (Emacs Polyglot) allows to connect to [a server](https://github.com/joaotavora/eglot?tab=readme-ov-file#connecting-to-a-server) in 40 languages

And of course, it works with corfu and orderless!
