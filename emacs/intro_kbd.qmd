...
Because so many Emacs kbds involve the Control key, it can be very tiresome for the pinky finger. Most Emacs users remap their keyboard to have the Caps lock key into another Control key.
