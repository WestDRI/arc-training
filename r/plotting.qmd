...
If you want to create multiple plots in the same frame, you simply add them to each other (you may have to make a few changes to the labels to improve their integration):
...
For instance the [`patchwork`](https://patchwork.data-imaginist.com/) package allows to easily create more complex layouts and the [`gganimate`](https://gganimate.com/) package allows to create data animations.

A full list of extensions for `ggplot2` can be found [here](https://exts.ggplot2.tidyverse.org/gallery/).
