...
<script type="application/ld+json">
{
  ...
  "name": "Introduction to R for the humanities",
  ...
  "url": "https://mint.westdri.ca/r/ws_hss_intro",
  "learningResourceType": "workshop, video",
  "inLanguage": "en",
...
This will take you to our JupyterHub. There, click on the [RStudio]{.codelike} button and our RStudio server will open in a new tab.

### Using RStudio

For those unfamiliar with the RStudio IDE, you can download the following cheatsheet:

[![from <a href="https://posit.co/resources/cheatsheets/">Posit Cheatsheets</a>](img/rstudio-ide_1.jpg)](https://posit.co/wp-content/uploads/2022/10/rstudio-ide-1.pdf)
