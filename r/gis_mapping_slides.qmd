---
title: "<span style=\"font-size: 7rem;\">GIS mapping in R</span>"
title-slide-attributes:
  data-background-image: img/bg1.jpg
  data-background-size: cover
  data-background-opacity: "0.8"
author: "<span style=\"font-size: 5rem;\">Marie-Hélène Burle</span>"
text: "<span style=\"font-size: 3rem;\">April 26, 2021</span>"
execute:
  error: true
  echo: true
format:
  revealjs:
    ...
    footer: <a href="gis_mapping.html"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="rgb(153, 153, 153)" class="bi bi-arrow-90deg-up" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M4.854 1.146a.5.5 0 0 0-.708 0l-4 4a.5.5 0 1 0 .708.708L4 2.707V12.5A2.5 2.5 0 0 0 6.5 15h8a.5.5 0 0 0 0-1h-8A1.5 1.5 0 0 1 5 12.5V2.707l3.146 3.147a.5.5 0 1 0 .708-.708l-4-4z"/></svg>&nbsp;Back to workshop page</a>
revealjs-plugins:
  - pointer
---
...
## <a href="http://vita.had.co.nz/papers/layered-grammar.pdf">Layered grammar of graphics</a> GIS maps
...
<div style="font-size: 1.2rem; margin: 1.5rem 0 1rem 0.1rem; text-align: left; color: #802b00">[Out]</div>
...
<div style="font-size: 20px; margin: 1.5rem 0 1rem 0.1rem; text-align: left; color: #802b00">[Out]</div>
