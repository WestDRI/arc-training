...
<script type="application/ld+json">
{
  ...
  "description": "In this webinar, we will see how to create all sorts of GIS maps with the packages sf, tmap, raster, leaflet, ggplot2, grid (part of Base R), and mapview:\n\n- simple maps \n\n- inset maps \n\n- faceted maps \n\n- animated maps \n\n- interactive maps \n\n- raster maps \n\nFinally, we will learn how to add basemaps from OpenStreetMap and Google Maps.",
