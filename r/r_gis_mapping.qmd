...
Tiled web maps are interactive maps in a browser using web servers such as Google Maps or OpenStreetMap. Several packages allow to use [Leaflet](https://leafletjs.com/) to create tile maps.
...
- *view*, an interactive viewing mode using [Leaflet](https://leafletjs.com/).
