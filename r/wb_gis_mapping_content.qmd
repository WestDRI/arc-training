...
*Content from [the webinar slides](wb_gis_mapping_slides.qmd) for easier browsing.*
...
[![](img/sf_cs_1.jpg)](https://posit.co/wp-content/uploads/2022/10/sf.pdf)

[![](img/sf_cs_2.jpg)](https://posit.co/wp-content/uploads/2022/10/sf.pdf)

### sf objects

![](img/sf_object_1_nw.png)

![](img/sf_object_2_nw.png)

![](img/sf_object_3_nw.png)

![](img/sf_object_4_nw.png)

![](img/sf_object_5_nw.png)
...
`tmap` is a [layered grammar of graphics](http://vita.had.co.nz/papers/layered-grammar.pdf) GIS map framework.
...
## Example: glaciers melt in N America
...
![](img/ag_thickness_blue.png){width="50%"}
...
![](img/ag_thickness_blue_res.png){width="50%"}

Or we can use a continuous colour scheme with `tm_raster(style = "cont")`:

![](img/ag_thickness_blue_cont.png){width="50%"}
...
![CartoDB.Positron](img/mapview4.jpg){width="50%"}

![OpenStreetMap](img/mapview3.jpg){width="50%"}

![OpenTopoMap](img/mapview1.jpg){width="50%"}

![Esri.WorldImagery](img/mapview2.jpg){width="50%"}
