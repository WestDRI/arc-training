...
Let's consider the calculation of the [Fibonacci numbers](https://en.wikipedia.org/wiki/Fibonacci_number) as an example. Those numbers form a sequence starting with `0` and `1`[^1], after which each number is the sum of the previous two (so it starts with: 0, 1, 1, 2, 3, 5, 8, 13...).
