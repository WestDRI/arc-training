...
One way to assess this is to run your code (without any explicit parallelization) and look at the number of cores running with tools such as [htop](https://htop.dev/). We will see an example of this later.
