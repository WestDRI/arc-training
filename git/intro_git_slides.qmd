...
format:
  revealjs:
    ...
    footer: <a href="intro_git.qmd"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="rgb(153, 153, 153)" class="bi bi-arrow-90deg-up" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M4.854 1.146a.5.5 0 0 0-.708 0l-4 4a.5.5 0 1 0 .708.708L4 2.707V12.5A2.5 2.5 0 0 0 6.5 15h8a.5.5 0 0 0 0-1h-8A1.5 1.5 0 0 1 5 12.5V2.707l3.146 3.147a.5.5 0 1 0 .708-.708l-4-4z"/></svg>&nbsp;Back to the course</a>
    slide-level: 0
    auto-stretch: false
revealjs-plugins:
  - pointer
...
In distributed VCS, the full history of projects lives on everybody's machine—as opposed to being only stored on a central server as was the case with centralized VCS. This allows for offline work and multiple backups, and [synchronous work]{.emph}
...
![From [xkcd.com](https://xkcd.com/)](https://imgs.xkcd.com/comics/git.png){width=60%}
