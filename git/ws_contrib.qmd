...
<script type="application/ld+json">
{
  ...
  "name": "Contributing to projects on GitHub",
  "description": "There are countless free and open source tools on GitHub and if you use one such tool and find a problem or think that you can improve the project, or if you would like to request a novel feature, how do you go about it?\n\nIn this workshop, we will learn how to contribute to open source projects hosted on GitHub by opening issues and submitting pull requests.",
  "url": "https://mint.westdri.ca/git/ws_contrib",
  ...
  "keywords": "Git, version control, contribution",
  "author": {
    "@type": "Person",
...
GitHub has also now implemented the ability to open [Discussions]{.codelike}. If enabled by the maintainer of a project, this is the place where you want to ask for help.

## Forking a project

Now, a more advanced approach is to actually make changes to the code of the project.

If you want to develop your own version of the project, you can fork the GitHub repository: go to GitHub and fork the project by clicking on the [Fork]{.codelike} button in the top right corner.
