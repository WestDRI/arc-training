...
There are 2 situations in which you do not have write access to a project:

- you are an outsider (e.g. you are contributing to an open source project),
- you are part of the team, but the person in charge wants a controlled workflow via [pull requests (PRs)](https://en.wikipedia.org/wiki/Distributed_version_control#Pull_requests).
...
This is a way to bring the attention of the maintainer(s) of the project to a particular question without attempting to directly contribute to the code.
...
- (more applicable to the research collaboration framework) you want to point out a problem in the project or suggest future directions.

:::{.note}

If enabled by the maintainer of a project, the "Discussions" tab is the place where you want to ask for help or discuss topic less directly pertinent to improving the project.
