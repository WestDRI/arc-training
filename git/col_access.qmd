...
- Click on the [Settings]{.codelike} tab.
- Click on the [Manage access]{.codelike} section on the left-hand side (you will be prompted for your GitHub password).
- Click on the [Invite a collaborator]{.codelike} green button.
