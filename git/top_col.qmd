...
description: A course on working collaboratively via &nbsp;[![](img/logo_github_red.png){width="1.3em"}](https://github.com/)
...
<script type="application/ld+json">
{
  ...
  "description": "Git is excellent at merging different versions of projects. Furthermore, it is a distributed version control system, meaning that everybody has a full copy of the project locally and local copies exchange information via a shared remote (examples of remotes that allow for easy shared access include servers and Internet hosting services such as GitHub, GitLab, and Bitbucket). \nThese characteristics make Git a powerful collaboration tool: everybody can work simultaneously on their local copies—a huge benefit over having to work asynchronously on a unique copy sent back and forth! \nThis course will cover the various ways to collaborate on a project using GitHub as a shared remote.",
  "url": "https://mint.westdri.ca/git/top_col",
  ...
  ""keywords": "course, Git, version-control, GitHub, collaboration",
  "author": {
    "@type": "Person",
