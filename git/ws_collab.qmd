...
<script type="application/ld+json">
{
  ...
  "name": "Collaborating through Git & GitHub",
  "description": "Using Internet hosting services such as [GitHub](https://github.com/), Git is a powerful collaboration tool.\n\nIn this workshop, we will cover the three classic collaboration situations and see how a collaborative workflow works.",
  "url": "https://mint.westdri.ca/git/ws_collab",
