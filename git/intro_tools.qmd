...
It is [easy to install on your machine](https://github.com/junegunn/fzf?tab=readme-ov-file#installation) and can also be installed on the Alliance clusters with:
