...
Remember that whenever you benchmark JAX computations, [you need to use the `block_until_ready` method](/ai/jx/jx_benchmark.qmd), due to asynchronous dispatch, to ensure that you are timing the computation and not the creation of a [future](https://en.wikipedia.org/wiki/Futures_and_promises).
