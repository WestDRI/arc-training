...
With the success of [Triton](https://github.com/triton-lang/triton), JAX built [the Pallas extension](https://jax.readthedocs.io/en/latest/pallas/index.html) that allows JAX users to write GPU kernels.
