...
The entire JAX environment is in active development so you might want to refer to the [JAX website](https://docs.jax.dev/en/latest/) and the [Awesome JAX project](https://github.com/n2cholas/awesome-jax) for up-to-date lists.
