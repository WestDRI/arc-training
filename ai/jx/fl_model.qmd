...
[As we already saw](https://mint.westdri.ca/ai/jx/fl_state#example-pytorch-vs-flax), Linen provides two syntaxes that are perfectly equivalent—a longer, more redundant, more customizable, and more PyTorch-like and a compact one—let's use the latter:
