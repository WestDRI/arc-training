...
Flax [fontcolor="#669900"]

{rank=same; "Load\ndataset" PyTorch TensorFlow 🤗}
"Load\ndataset" -> PyTorch -> TensorFlow -> 🤗 [style=invis]

{rank=same; "Define\narchitecture" flax1}
"Define\narchitecture" -> flax1 [style=invis]

jax1 [label=<<FONT COLOR="deepskyblue3">JAX</FONT><FONT COLOR="darkorange4">Optax </FONT><FONT COLOR="darkorange4">Orbax</FONT>>]

JAX [fontcolor=deepskyblue3]

{PyTorch TensorFlow 🤗} -> flax1 -> jax1 -> JAX -> Flax
