...
Pytrees are very useful when using JAX for deep learning. [Our course on DL with Flax](/ai/top_fl.qmd) will show this, but below is a basic example modified from [the JAX documentation](https://jax.readthedocs.io/en/latest/jax-101/05.1-pytrees.html#example-ml-model-parameters).
