...
But beyond extremely simple examples, Bayesian inference is mathematically arduous
...
Relies on No-U-Turn sampler (NUTS), a variant of [Hamiltonian Monte Carlo (HMC)](https://en.wikipedia.org/wiki/Hamiltonian_Monte_Carlo)—see [HMC paper](https://arxiv.org/abs/1701.02434)

Superior to Gibbs sampler ➔ made Stan a very popular PPL for years

HMC and variants require burdensome calculations of derivatives

Stan solved that by creating its own reverse-mode [automatic differentiation](https://en.wikipedia.org/wiki/Automatic_differentiation) engine
...
<iframe width="900" height="600" src="https://docs.jax.dev/en/latest/index.html#ecosystem"></iframe>
...
PyMC is a PPL based on [PyTensor](https://github.com/pymc-devs/pytensor)—fork of [aesara](https://github.com/aesara-devs/aesara), itself a fork of [Theano](https://github.com/Theano/Theano)

It relies on building a static graph
...
*Not a PPL but a library of MCMC samplers for Python*

Can be used directly if you want to define your own log-probability density functions or can be used with several PPLs (make sure to translate the model into a log-probability function)

Also provides building blocks for experimentation with new algorithms

## Blackjax {.center}

<iframe width="900" height="600" src="https://blackjax-devs.github.io/blackjax/index.html#hello-world"></iframe>

## Example Blackjax sampler: HMC {.center}

<iframe width="900" height="600" src="https://blackjax-devs.github.io/blackjax/autoapi/blackjax/mcmc/hmc/index.html"></iframe>

## Example Blackjax sampler: NUTS {.center}

<iframe width="900" height="600" src="https://blackjax-devs.github.io/blackjax/autoapi/blackjax/mcmc/nuts/index.html"></iframe>

## Which tool to choose? {.center}

All these tools are in active development (JAX was released and started shaking the field in 2018). Things are fast evolving. Reading blogs of main developers, posts on [Hacker News](https://en.wikipedia.org/wiki/Hacker_News), discourse forums, etc. helps keeping on eye on the evolutions in the field
...
[Several resources on the PyMC website](https://www.pymc.io/projects/docs/en/stable/learn.html)
...
<iframe width="900" height="400" src="https://xcelab.net/rm/"></iframe>
