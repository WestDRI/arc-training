...
The frequentist approach is computationally simple and fast and returns summary statistics
...
[Markov chain Monte Carlo (MCMC)](https://en.wikipedia.org/wiki/Markov_chain_Monte_Carlo) is a class of sampling algorithms which explore the posterior distribution
...
<iframe width="760" height="500" src="https://num.pyro.ai/en/stable/"></iframe>
