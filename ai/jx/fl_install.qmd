...
The CPU version of JAX will get installed as a dependency to Flax. [Install another JAX version](https://jax.readthedocs.io/en/latest/installation.html) if you need.
