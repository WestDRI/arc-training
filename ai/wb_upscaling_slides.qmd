...
# History of super-resolution {.center}
...
### [Nearest-neighbour interpolation](https://en.wikipedia.org/wiki/Nearest-neighbor_interpolation) {.center}

Simplest method of interpolation

Simply uses the value of the nearest pixel

### [Bicubic interpolation](https://en.wikipedia.org/wiki/Bicubic_interpolation) {.center}
...
### SR using (amongst others): {.center}
...
### [Set5](https://paperswithcode.com/dataset/set5) {.center}

![](img/set5.png){width="30%"}

### [Set14](https://paperswithcode.com/dataset/set14) {.center}

![](img/set14.png){width="70%"}

### [BSD100 (Berkeley Segmentation Dataset)](https://paperswithcode.com/dataset/bsd100) {.center}
...
#### PSNR vs number of parameters for different methods on Set5x4 {.center}
...
#### Comparison between SwinIR & a representative CNN-based model (RCAN) on classical SR images x4 {.center}
