...
description: Training a classification model on your own data with [![](jxai/img/logo_jaxstack.png){width="1.4em" fig-alt="noshadow"}](https://github.com/google/flax)
