...
aliases:
  - /ai/jxai/fl_jax_slides
frontpic: /ai/jx/img/logo_jax.png
frontpicwidth: 50%
...
from [JAX documentation](https://docs.jax.dev/en/latest/installation.html#supported-platforms)
...
The meta-library [jax-ai-stack](https://github.com/jax-ml/jax-ai-stack) makes this easier to manage (install `jax[cuda13]` first for GPU)

:::{.def}

On your machine (*and your machine only*), a great tool to manage Python versions and packages is [uv](https://github.com/astral-sh/uv) (see [our webinar](/python/wb_uv.qmd)). On the clusters, you have to use `module` to load the Python version you want and `pip` to install packages
