...
aliases:
  - /ai/jxai/fl_preprocess
bibliography: fl.bib
csl: ../../diabetologia.csl
author:
  - Marie-Hélène Burle
  - Adapted from JAX's [Implement ViT from scratch](https://docs.jaxstack.ai/en/latest/JAX_Vision_transformer.html)
---
...
bgcolor="transparent"
node [fontname="Inconsolata, sans-serif", color=gray55, fontsize="18pt", fontcolor=darkgoldenrod]
edge [color=gray55]
...
def display_datapoints(*datapoints, tag="", names_map=None):
    ...
    fig, axs = plt.subplots(1, num_samples, figsize=(8.5, 9))
