...
![Neurons are in green, the dark branches are blood vessels. Image by [Na Ji, UC Berkeley](https://news.berkeley.edu/2020/03/19/high-speed-microscope-captures-fleeting-brain-signals/)](../img/brain_neurons.jpg){fig-alt="noshadow" width=72%}
...
![Modified from [Blacktc, Wikimedia](https://commons.wikimedia.org/w/index.php?curid=78013076)](../img/all_none_law.png){fig-alt="noshadow" width=74%}

*Some of the most common activation functions in artificial neurons:*

![from [Diganta Misra 2019](https://arxiv.org/abs/1908.08681)](../img/act_func.png){fig-alt="noshadow" width=74%}
...
![from [Glosser.ca, Wikipedia](https://commons.wikimedia.org/w/index.php?curid=24913461)](../img/nn.png){fig-alt="noshadow" width=35%}
