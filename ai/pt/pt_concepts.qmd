...
![from [xkcd.com](https://xkcd.com/)](https://imgs.xkcd.com/comics/machine_learning_captcha.png)
...
![from [xkcd.com](https://xkcd.com/)](https://imgs.xkcd.com/comics/trained_a_neural_net.png)
...
![from [Dhp1080, Wikipedia](https://commons.wikimedia.org/w/index.php?curid=1474927)](https://upload.wikimedia.org/wikipedia/commons/b/b5/Neuron.svg)

*Schematic of an artificial neuron:*

![Modified from [O.C. Akgun & J. Mei 2019](https://royalsocietypublishing.org/doi/10.1098/rsta.2019.0163)](../img/artificial_neuron.png){width=70%}
...
![Neurons are in green, the dark branches are blood vessels. Image by [Na Ji, UC Berkeley](https://news.berkeley.edu/2020/03/19/high-speed-microscope-captures-fleeting-brain-signals/)](../img/brain_neurons.jpg){width=72%}
...
![Modified from [Blacktc, Wikimedia](https://commons.wikimedia.org/w/index.php?curid=78013076)](../img/all_none_law.png){width=74%}

*Some of the most common activation functions in artificial neurons:*

![from [Diganta Misra 2019](https://arxiv.org/abs/1908.08681)](../img/act_func.png){width=74%}
...
![from [Glosser.ca, Wikipedia](https://commons.wikimedia.org/w/index.php?curid=24913461)](../img/nn.png){width=35%}
...
![from [xkcd.com](https://xkcd.com/)](https://imgs.xkcd.com/comics/drone_training.png)
