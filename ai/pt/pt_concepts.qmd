...
![from [xkcd.com](https://xkcd.com/)](https://imgs.xkcd.com/comics/machine_learning_captcha.png){fig-alt="noshadow"}
...
![from [xkcd.com](https://xkcd.com/)](https://imgs.xkcd.com/comics/trained_a_neural_net.png){fig-alt="noshadow"}
...
![from [Programming Journeys by Rensu Theart](https://codetolight.wordpress.com/2017/11/29/getting-started-with-pytorch-for-deep-learning-part-3-neural-network-basics/)](../img/cnn.png){fig-alt="noshadow"}
...
![from [fdeloche, Wikipedia](https://commons.wikimedia.org/wiki/File:Recurrent_neural_network_unfold.svg)](../img/rnn.png){fig-alt="noshadow"}
...
![from [xkcd.com](https://xkcd.com/)](https://imgs.xkcd.com/comics/drone_training.png){fig-alt="noshadow"}
