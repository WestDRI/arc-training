...
![Modified from Stevens, E., Antiga, L., & Viehmann, T. (2020). Deep learning with PyTorch. Manning Publications](img/ml1.png){width="70%"}

The information needs to be converted to numbers:

![Modified from Stevens, E., Antiga, L., & Viehmann, T. (2020). Deep learning with PyTorch. Manning Publications](img/ml2.png){width="70%"}

These numbers must be stored in a data structure:

[PyTorch tensors are Python objects holding multidimensional arrays.]{.emph}

![Stevens, E., Antiga, L., & Viehmann, T. (2020). Deep learning with PyTorch. Manning Publications](img/tensor.png){width="70%"}
...
![Stevens, E., Antiga, L., & Viehmann, T. (2020). Deep learning with PyTorch. Manning Publications](img/memory_storage.png){width="70%"}
...
![Stevens, E., Antiga, L., & Viehmann, T. (2020). Deep learning with PyTorch. Manning Publications](img/tensor_metadata.png){width="70%"}
...
![&nbsp;](img/my_tensor_metadata.jpg){width="70%"}
...
![Stevens, E., Antiga, L., & Viehmann, T. (2020). Deep learning with PyTorch. Manning Publications](img/sharing_storage.png){width="70%"}
...
![Stevens, E., Antiga, L., & Viehmann, T. (2020). Deep learning with PyTorch. Manning Publications](img/transpose.png){width="70%"}
