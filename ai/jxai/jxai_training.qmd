...
The loss decreased in a very jagged fashion due to my small batch size. With more memory and a bigger batch size, the descent would have been smoother. To get a smoother descent with small batches, I could have decreased the learning rate, increased the momentum, or calculated them for several batches before passing them to the backpropagation.
