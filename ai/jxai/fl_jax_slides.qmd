...
## Installing other "modules" {.center}
...
On your machine (*and your machine only*), a great tool to manage Python versions and all those packages is [uv](https://github.com/astral-sh/uv). ([Webinar coming soon](https://mint.westdri.ca/python/wb_uv)). On the clusters, you have to use `module` to load the Python version you want and `pip` to install packages
