...
Please do not run the code in this section:
...
I ran this ahead of time and already created the cropped files.
...
You can start running the code again starting in the next section.
