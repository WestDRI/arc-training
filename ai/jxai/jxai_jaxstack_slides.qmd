...
format:
  revealjs:
    ...
    footer: <a href="jxai_jaxstack.qmd"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="rgb(0,105,92)" class="bi bi-arrow-90deg-up" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M4.854 1.146a.5.5 0 0 0-.708 0l-4 4a.5.5 0 1 0 .708.708L4 2.707V12.5A2.5 2.5 0 0 0 6.5 15h8a.5.5 0 0 0 0-1h-8A1.5 1.5 0 0 1 5 12.5V2.707l3.146 3.147a.5.5 0 1 0 .708-.708l-4-4z"/></svg>&nbsp;Back to the course</a>
    auto-stretch: false
revealjs-plugins:
  - pointer
---
...
E [label="Pure functions only\n(subset of Python)", shape=plaintext, fontcolor=darkorchid2, group=g4]
...
![from the [JAX AI Stack website](https://docs.jaxstack.ai/en/latest/index.html)](img/jx_ecosystem.jpg){fig-alt="noshadow"}
