---
title: Saving the model for inference
...
```{.python filename="nabirds_train.py"}
import os
import polars as pl
...
```{.python filename="nabirds_infer.py"}
import os
import sys
import jax
import jax.numpy as jnp
...
<!-- Let's pick some random picture from the internet: -->

<!-- ![[© Steven Mlodinow / Macaulay Library](https://macaulaylibrary.org/asset/45426151)](img/song_sparrow.jpg) -->
