...
## 1^st^ stage (data preparation) {.center}
...
From now on, if I edit one of the scripts, or one of the dependencies, `dvc status` will tell me what changed and `dvc repro` will only rerun the parts of the pipeline to update the result, pretty much as a Makefile would
