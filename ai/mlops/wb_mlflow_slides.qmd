...
with mlflow.start_run(run_name="run_1") as run:
    ...
    for epoch in range(params["epochs"]):
        ...
        mlflow.pytorch.log_model(model, name=f"fashionmnist_1_checkpoint_{epoch}")
    ...
    model_info = mlflow.pytorch.log_model(model, name="fashionmnist_1_trained")
```
...
with mlflow.start_run(run_name="run_2") as run:
    ...
    for epoch in range(params["epochs"]):
        ...
        # Log checkpoint at the end of each epoch
        mlflow.pytorch.log_model(model, name=f"fashionmnist_2_checkpoint_{epoch}")
    ...
    # Log the final trained model
    model_info = mlflow.pytorch.log_model(model, name="fashionmnist_2_trained")
```
...
## Register models in the UI {.center}
...
## Register models programmatically {.center}
