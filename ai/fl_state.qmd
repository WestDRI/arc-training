...
Frameworks based on JAX such as [Flax](https://flax.readthedocs.io/en/latest/index.html) as well as the Julia package [Lux](https://lux.csail.mit.edu/) (a modern rewrite of Flux [with explicit model parameters and a philosophy similar to JAX's](https://lux.csail.mit.edu/dev/introduction/overview)) follow this approach.
