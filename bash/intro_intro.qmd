...
You will be asked whether you are sure that you want to add the hostname to your list of trusted hosts. Answer "yes".

You are now logged in and your prompt should look like the following (with your actual user name):
