...
If you want to be able to run the Lmod commands (`module list`, `module spider`, `module load`, etc.), you need to launch Zsh as a login shell with:
...
If you don't, you will get the error: `zsh: command not found: module`.
