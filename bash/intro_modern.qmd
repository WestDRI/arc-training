...
In recent years, a number of popular open source tools have emerged which replace some of the classic Unix utilities. Depending on the tool, they improve performance, are more user friendly, or add novel functionality.
...
[zoxide](https://github.com/ajeetdsouza/zoxide) allows you to jump to directories extremely quickly and easily.
