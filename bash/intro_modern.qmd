...
Instructions to install zoxide on your machine can be found [here](https://github.com/ajeetdsouza/zoxide?tab=readme-ov-file#installation). Note that fzf [(see below)](#fuzzy-finder-fzf) adds cool functionality to it, so you might want to install it as well.
