...
[zoxide](https://github.com/ajeetdsouza/zoxide) allows you to easily jump to any directory.

### Installation

Instructions to install zoxide on your machine can be found [here](https://github.com/ajeetdsouza/zoxide?tab=readme-ov-file#installation). It works well with [fzf](#fuzzy-finder-fzf).
