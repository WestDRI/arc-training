...
`autojump` is installed on the Alliance clusters. To install it on your machine, you can follow the instructions [here](https://github.com/wting/autojump?tab=readme-ov-file#installation).

:::{.notes}

`autojump` just got installed on the clusters and is not functional yet. It will be so within days.
