...
`C-l` means: press the [Ctrl]{.codelike} and [l]{.codelike} keys at the same time.

`M-f` means: press the [Alt]{.codelike} (Windows) or [Option]{.codelike} (macOS) and [f]{.codelike} keys at the same time.
