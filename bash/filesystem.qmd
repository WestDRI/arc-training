...
strict graph {
  bgcolor="transparent"
  node [color=chocolate, fontcolor=chocolate3, shape=folder, fontname="Inconsolata, sans-serif"]
  edge [color=tan, penwidth=0.5]
  
  ".bashrc" [shape=plain, fontcolor=darkolivegreen]
  ".bash_profile" [shape=plain, fontcolor=darkolivegreen]
  graph1 [shape=plain, fontcolor=darkolivegreen]
  graph2 [shape=plain, fontcolor=darkolivegreen]
  script1 [shape=plain, fontcolor=darkolivegreen]

  user001 [style=filled, fillcolor=chocolate, fontcolor=black]
