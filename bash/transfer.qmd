...
If, instead of an occasional copying of files between your machine and the cluster, you want to keep a directory in sync between both machines, you might want to use [rsync](https://en.wikipedia.org/wiki/Rsync) instead.

You can look at [the Alliance wiki page on rsync](https://docs.alliancecan.ca/wiki/Transferring_data#Rsync) for complete instructions.
