...
To get a very good model at the end—one that can write human language like ChatGPT or voice assistants for instance—you need **A LOT OF DATA**
...
![[Karunathilake, E. M. B. M., Le, A. T., Heo, S., Chung, Y. S., & Mansoor, S. (2023). The path to smart farming: Innovations and opportunities in precision agriculture. Agriculture, 13(8), 1593.](https://www.mdpi.com/2077-0472/13/8/1593)](img/smartfarming.png){fig-alt="noshadow" width="80%"}
...
![[Karunathilake, E. M. B. M., Le, A. T., Heo, S., Chung, Y. S., & Mansoor, S. (2023). The path to smart farming: Innovations and opportunities in precision agriculture. Agriculture, 13(8), 1593.](https://www.mdpi.com/2077-0472/13/8/1593)](img/ai_in_agriculture.png){fig-alt="noshadow"}
...
![[Jung, D. H., Kim, N. Y., Moon, S. H., Jhin, C., Kim, H. J., Yang, J. S., ... & Park, S. H. (2021). Deep learning-based cattle vocal classification model and real-time livestock monitoring system with noise filtering. Animals, 11(2), 357.](https://www.mdpi.com/2076-2615/11/2/357)](img/livestock.png){fig-alt="noshadow"}
