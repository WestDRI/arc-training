...
This workshop will be followed by [a 2<sup>nd</sup> session on challenges and solutions while working with big data](2024_bccai_part2_slides.qmd){target="_blank"}
...
## The 3 "V" of big data {.center}

Big data is often defined by the 3 "V":
...
<!-- Sometimes people talk about the 4 or even 5 "V", adding **veracity** and/or **value** -->
...
Recent years have seen a rapid increase of hardware capacity to store and process data
