...
[Simon Fraser University](https://www.sfu.ca/) hosts the [Cedar supercomputer](https://www.sfu.ca/research/supercomputer-cedar)—a cluster of 100,400 CPUs and 1,352 GPUs [soon to be replaced by an even larger computer cluster](https://www.sfu.ca/sfunews/stories/2024/06/sfu-awarded--80-million-to-upgrade-supercomputing-facility-.html)—and works with the [Digital Research Alliance of Canada](https://alliancecan.ca/en) to offer researchers large amounts of computing power as well as training to optimize their code

## SFU BC Centre for Agritech Innovation {.center}

[SFU BCCAI](https://www.sfu.ca/agritech-innovation.html) delivers our mandate through these 3 pillars:
...
## Getting in touch with SFU's BDH {.center}
...
- Scientific advise in agritech: xxx
- Partnering consulting firms: xxx
...
We will discuss challenges and solutions while working with big data

<br>

:::{.note}

If you are unable to attend, you can find the slides [online](2024_bccai_part2_slides.qmd){target="_blank"}, but it will be an interactive and hands-on session with most of the material covered in the activities

:::

## Feedback {.center}

Please give us feedback by scanning the following QR code:
