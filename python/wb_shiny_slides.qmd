...
<iframe sandbox="allow-same-site-none-cookies" width="900" height="600" src="https://shiny.posit.co/py/components/" data-external="1"></iframe>

## Example input {.center}

:::{.note}

If a cookie pop-up prevents you from using the site in the iframe below, you can access it [here](https://shiny.posit.co/py/components/inputs/slider/) instead.
...
If a cookie pop-up prevents you from using the site in the iframe below, you can access it [here](https://shiny.posit.co/py/components/outputs/plot-seaborn/) instead.
...
<iframe sandbox="allow-same-site-none-cookies" width="900" height="600" src="https://shiny.posit.co/py/layouts/" data-external="1"></iframe>

## Example layout {.center}

:::{.note}

If a cookie pop-up prevents you from using the site in the iframe below, you can access it [here](https://shiny.posit.co/py/layouts/sidebars/#sidebar-on-the-left) instead.
...
<iframe sandbox="allow-same-site-none-cookies" width="900" height="600" src="https://shiny.posit.co/py/templates/" data-external="1"></iframe>
...
Create a [GitHub gist](https://gist.github.com/) and share it at: \
...
## Comparison with Plotly Dash {.center}
