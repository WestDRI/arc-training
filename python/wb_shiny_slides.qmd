...
Watch your app at [127.0.0.1:8000]{.codelike}
...
One of them is the delay in launching apps

Another is that you can't collect data. This app is thus for demo only and cannot be used unless deployed in a standard Shiny server
...
![](img/shinylive_shiny_deployment_model.png)

<br><br>A server runs the app
...
Deploy to GitHub pages, Netlify, your own website...
