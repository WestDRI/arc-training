...
We are providing a virtual training cluster for this course, but it only contains Polars for CPU (see [the previous section about RAPIDS on the Alliance clusters](cudf_install.qmd#on-alliance-clusters)). I will demo Polars cuDF on my machine.
...
<!-- - Replace `usexxx` by your username (e.g. `user09`). -->
