...
- The more Python you know, the easier it will get to be critical of the code. But don't hesitate to use the LLM to explain the code to you. They will help you learn.
