...
Between which elements do you think that `'test'` will be inserted if I run:
...
Note that this only works when all elements are at the same level of nesting. So this method won't work on lists such as:
