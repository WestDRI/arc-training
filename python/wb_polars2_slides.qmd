...
First, we create a LazyFrame instead of a DataFrame. The query is not evaluated but a graph is created. This allows the query optimizer to combine operations and perform [optimizations](https://docs.pola.rs/user-guide/lazy/optimizations/) where possible, very much the way compilers work
...
*Remember that this DataFrame would require 10 GB if used in pandas!*
