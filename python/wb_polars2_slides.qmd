...
For historical reasons, depending on dtype, missing values are either of:
...
Leads to inconsistent behaviour and unexpected dtype changes

[Ongoing issue](https://github.com/pandas-dev/pandas/issues/32265) since 2020
...
Simple and consistent behaviour across all data types. Better performance

`NaN` exists and is a type of float. It is **not** missing data. Instead, it is the result of mathematical operations that don't return numbers
