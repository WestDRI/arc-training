...
The method is as easy as everything we have seen so far: you simply use the `sentiment` attribute of a `TextBlob` object and you get a named tuple with the positivity on a continuous scale from -1 to +1 and a subjectivity ranging from 0 to 1.
...
If TextBlob does a good job at analysing those reviews, we should get a positivity close to 1 for four and five-star reviews and a positivity close to -1 for one-star reviews.
