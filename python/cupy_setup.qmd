...
[This is for future reference. During the course, we will use [a temporary training cluster](#for-this-course).]{.emph}
...
**Do not run the following today or it will mess up with our preset environment.**
