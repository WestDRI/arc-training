...
#### Write your query on the LazyFrame

Run the query you were interested in on the LazyFrame (no impact on memory, the LazyFrame and the query graph are returned instantly because they correspond to unresolved futures):
