...
There are fancy tools to scrape the web and play with text. In preparation for those, in this workshop, we will download a text file from the internet and play with it using simple commands.
...
<script type="application/ld+json">
{
  ...
  "name": "Playing with text in Python",
  "description": "There are fancy tools to scrape the web and play with text. In preparation for those, in this workshop, we will download a text file from the internet and play with it using simple commands.",
  "url": "https://mint.westdri.ca/python/ws_text",
  ...
  "keywords": "Python, text, request, string",
  "author": {
    "@type": "Person",
