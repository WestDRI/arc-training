...
For non-specialists, the deep learning literature and programming forums might not be the best ways to keep up to date with the evolution of these tools. What has worked best for me is to follow a number of podcasts. In particular, I like [Hard Fork](https://www.nytimes.com/column/hard-fork) from the [New Yor Times](https://www.nytimes.com/)—a fun and approachable, but well-researched podcast on technology which often deals with AI, as well as [podcast](https://www.lawfaremedia.org/podcasts-multimedia/podcast) episodes from [Lawfare](https://en.wikipedia.org/wiki/Lawfare_(website)) dealing with AI for questions related to law and geopolitics. There are many other podcasts on AI but they tend to target a technical audience.
