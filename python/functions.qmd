...
Python comes with several [built-in functions](https://docs.python.org/3/library/functions.html).
...
You can install packages containing additional functions.

## Writing functions

You can also write your own functions to do exactly what you want.
...
Once defined, our function can be used as any other function.
...
Now you can access the documentation of your function as you would any Python function:
