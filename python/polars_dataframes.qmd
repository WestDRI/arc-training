...
[Lazy evaluation is not yet implemented when reading files from the cloud](https://github.com/pola-rs/polars/issues/13115) (Polars is a very new tool, but its functionalities are expanding very fast).
...
Note that Polars also has a `pl.read_csv` function if you want to use the eager evaluation.
