...
This workshop is an introduction to [pandas](https://pandas.pydata.org/), a Python library to manipulate DataFrames and time series, via an exploration of the Covid-19 data from [Johns Hopkins University CSSE repository](https://github.com/CSSEGISandData/COVID-19).
...
<script type="application/ld+json">
{
  ...
  "name": "DataFrames with pandas",
  "description": "This workshop is an introduction to [pandas](https://pandas.pydata.org/), a Python library to manipulate DataFrames and time series, via an exploration of the Covid-19 data from [Johns Hopkins University CSSE repository](https://github.com/CSSEGISandData/COVID-19).",
  "url": "https://mint.westdri.ca/python/ws_pandas",
  ...
  "keywords": "Python, DataFrame, pandas, Covid-19",
  "author": {
    "@type": "Person",
...
Finally, we index, out of our entire DataFrame, the rows for which that condition returns `True`:
