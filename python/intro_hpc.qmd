...
# to load Python 3.13.2, you need StdEnv/2023
# but it is loaded by default
# you can verify with module list
# so we can load our Python module directly
...
Now you need to write a job script for the Slurm scheduler.
