...
[TextBlob](https://textblob.readthedocs.io/en/stable/index.html) is the NLP package that we will use in this course for tagging, tokenization, sentiment analysis, etc.
...
We don't have to print the full list. Let's only print the first 30 tuples:
...
Here is the [tagset from the University of Pennsylvania](https://www.ling.upenn.edu/courses/Fall_2003/ling001/penn_treebank_pos.html) as a reference:
...
How many words are there in the first page of Wyrd Sisters?
