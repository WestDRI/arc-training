...
This section covers the handling of tabular data in Julia. We will use Covid-19 data as an example to practice loading, transforming, and plotting the data.
...
![from [xkcd.com](https://xkcd.com/)](https://imgs.xkcd.com/comics/coronavirus_charts.png)
...
![Data until March 22, 2020](img/world.png){title="Global confirmed, dead, recovered, and current up to March 22, 2020"}
...
![Data until March 22, 2020](img/northamerica.png){title="Confirmed, dead, recovered, and current in some North American countries/provinces until March 22, 2020"}
...
![Data until March 22, 2020](img/asia.png){title="Confirmed, dead, recovered, and current in some Asian countries until March 22, 2020"}
...
![Data until March 22, 2020](img/europe.png){title="Confirmed, dead, recovered, and current in some European countries until March 22, 2020"}
...
![Data until March 25, 2020](img/world1.png){title="Global confirmed and dead"}
...
![Data until March 25, 2020](img/4countries.png){title="Confirmed and dead for Italy, Spain, the US, and Canada"}
...
![Data until March 25, 2020](img/confirmed.png){title="Number of confirmed cases in a few countries"}
...
![Data until March 25, 2020](img/dead.png){title="Number of deaths in a few countries"}
