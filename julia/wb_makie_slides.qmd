...
format:
  revealjs:
    ...
    footer: <a href="wb_makie.qmd"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="rgb(153, 153, 153)" class="bi bi-arrow-90deg-up" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M4.854 1.146a.5.5 0 0 0-.708 0l-4 4a.5.5 0 1 0 .708.708L4 2.707V12.5A2.5 2.5 0 0 0 6.5 15h8a.5.5 0 0 0 0-1h-8A1.5 1.5 0 0 1 5 12.5V2.707l3.146 3.147a.5.5 0 1 0 .708-.708l-4-4z"/></svg>&nbsp;Back to webinar page</a>
revealjs-plugins:
  - pointer
---
...
![From: [Storopoli, Huijzer and Alonso (2021). Julia Data Science. ISBN: 97984898](https://juliadatascience.io/datavisMakie_attributes)](img/makiecheatsheet2D.png){width=55%}

## Cheatsheet 3D {.center}

![From: [Storopoli, Huijzer and Alonso (2021). Julia Data Science. ISBN: 97984898](https://juliadatascience.io/datavisMakie_attributes)](img/makiecheatsheet3D.png){width="55%"}
...
You don't have to create the `Figure`, `Axis`, and plot one at a time:
...
It is important to understand the concepts of `Figure` and `Axis` objects to customize them:

```{julia}
x = LinRange(-10, 10, 1000)
y = cos.(x)
lines(x, y;
      figure=(; backgroundcolor=:green, size=(1000, 400)),
...
You can setup a server with [JSServe.jl](https://github.com/SimonDanisch/JSServe.jl) as per [the documentation](https://docs.makie.org/dev/explanations/backends/wglmakie)
