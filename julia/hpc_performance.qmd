...
If there is one thing you need to remember from this lesson, it is to [avoid global variables]{.emph} (that is, avoid variables defined in the global environment).
