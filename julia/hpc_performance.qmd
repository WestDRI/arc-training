...
In this section, we cover an important point when it comes to Julia and performance: you should [avoid global variables]{.emph} (that is, avoid variables defined in the global environment) as much as possible.
