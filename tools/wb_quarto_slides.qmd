...
subtitle: Authoring dynamic scientific documents with ![](img/logo_quarto.png){width="5em"}
...
format:
  revealjs:
    ...
    footer: <a href="wb_quarto.qmd"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="rgb(153, 153, 153)" class="bi bi-arrow-90deg-up" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M4.854 1.146a.5.5 0 0 0-.708 0l-4 4a.5.5 0 1 0 .708.708L4 2.707V12.5A2.5 2.5 0 0 0 6.5 15h8a.5.5 0 0 0 0-1h-8A1.5 1.5 0 0 1 5 12.5V2.707l3.146 3.147a.5.5 0 1 0 .708-.708l-4-4z"/></svg>&nbsp;Back to webinar page</a>
revealjs-plugins:
  - pointer
---
...
![](img/qmd_jupyter.png){width="70%"}
[From [Quarto documentation](https://quarto.org/)]{.caption}

#### R:

![](img/qmd_knitr.png){width="70%"}
[From [Quarto documentation](https://quarto.org/)]{.caption}
...
## Document structure & syntax: front matter {.center}
...
## Some advantages of Quarto {.center}
...
You can find information [in the Quarto documentation](https://quarto.org/docs/get-started/) or [in our previous workshop on Quarto](quarto.html#installation.qmd){target="_blank"}

### Basic examples

You can find several examples [in our previous workshop on Quarto](ws_quarto.qmd){target="_blank"}
