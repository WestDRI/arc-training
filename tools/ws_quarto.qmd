---
title: Authoring scientific documents with Quarto
aliases:
  - quarto.html
...
<script type="application/ld+json">
{
  ...
  "name": "Authoring scientific documents with Quarto",
  "description": "This workshop will show you how to easily create beautiful scientific documents (html, pdf, websites, books…)—complete with formatted text, dynamic code, and figures with [Quarto](https://quarto.org/), an open-source tool combining the powers of Jupyter or knitr with Pandoc to turn your text and code blocks into fully dynamic and formatted documents.",
  "url": "https://mint.westdri.ca/tools/ws_quarto",
  ...
  "keywords": "Quarto, markup, R Markdown, publishing, markdown",
  "author": {
    "@type": "Person",
...
![from [Quarto documentation](https://quarto.org/)](img/qmd_jupyter.png)
...
![from [Quarto documentation](https://quarto.org/)](img/qmd_knitr.png)
...
![from [Quarto documentation](https://quarto.org/)](img/ipynb.png)
