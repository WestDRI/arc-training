...
![from [Quarto documentation](https://quarto.org/)](img/qmd_jupyter.png){fig-alt="noshadow"}
...
![from [Quarto documentation](https://quarto.org/)](img/qmd_knitr.png){fig-alt="noshadow"}
...
![from [Quarto documentation](https://quarto.org/)](img/ipynb.png){fig-alt="noshadow"}
